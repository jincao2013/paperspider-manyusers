...
Changse by Jin: 8rd Feb 2020
                - OS check part was removed :
                  sys.platform != 'darwin'
                  it seems works on OS X 10.15.2
...
class Daemon(object):
    ...
    def daemonize(self):
        ...
        if sys.platform != 'darwin: remove':  # This block breaks on OS X # it seems works on OS X 10.15.2
